...
inline void ResultCode::set_errormsg(const void* value,
    size_t size) {
...
inline std::string* ResultCode::unsafe_arena_release_errormsg() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.ResultCode.errormsg)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return errormsg_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ResultCode::unsafe_arena_set_allocated_errormsg(
    std::string* errormsg) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (errormsg != nullptr) {
  ...
  errormsg_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      errormsg, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.ResultCode.errormsg)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsRequest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetFriendListsRequest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRequest.id)
  return _internal_id();
}
inline void GetFriendListsRequest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  id_ = value;
}
inline void GetFriendListsRequest::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// repeated bytes name = 2;
inline int GetFriendListsResponse::_internal_name_size() const {
  return name_.size();
}
inline int GetFriendListsResponse::name_size() const {
  return _internal_name_size();
}
inline void GetFriendListsResponse::clear_name() {
  name_.Clear();
}
inline std::string* GetFriendListsResponse::add_name() {
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListsResponse.name)
  return _internal_add_name();
}
inline const std::string& GetFriendListsResponse::_internal_name(int index) const {
  return name_.Get(index);
}
inline const std::string& GetFriendListsResponse::name(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.name)
  return _internal_name(index);
}
inline std::string* GetFriendListsResponse::mutable_name(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.name)
  return name_.Mutable(index);
}
inline void GetFriendListsResponse::set_name(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.name)
  name_.Mutable(index)->assign(value);
}
inline void GetFriendListsResponse::set_name(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResponse.name)
  name_.Mutable(index)->assign(std::move(value));
}
inline void GetFriendListsResponse::set_name(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListsResponse.name)
}
inline void GetFriendListsResponse::set_name(int index, const void* value, size_t size) {
  name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListsResponse.name)
}
inline std::string* GetFriendListsResponse::_internal_add_name() {
  return name_.Add();
}
inline void GetFriendListsResponse::add_name(const std::string& value) {
  name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.name)
}
inline void GetFriendListsResponse::add_name(std::string&& value) {
  name_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.name)
}
inline void GetFriendListsResponse::add_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListsResponse.name)
}
inline void GetFriendListsResponse::add_name(const void* value, size_t size) {
  name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListsResponse.name)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListsResponse::name() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.name)
  return name_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListsResponse::mutable_name() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.name)
  return &name_;
}
